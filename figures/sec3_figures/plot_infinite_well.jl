...
V(x) = ifelse(abs(x)<=10.0, 0.0, 1000.0)
Nx = 4096
dx = 0.05
dt = 0.02
...
plot!(xlim=(-15,15), ylim=(-0.05,0.5), legend=:none, framestyle=:box, xlabel=raw"position $x$", ylabel=raw"energy $E$")

savefig("figures/sec3_figures/infinite_well_eigenstates.pdf")
