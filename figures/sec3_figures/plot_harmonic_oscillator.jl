...
annotate!(-3.0, -0.01, text(raw"$V(x)$", :left, :top))
annotate!(-9.5, job_im.E0[1], text(raw"$ψ_1(x)$", :left, :bottom))
annotate!(-9.5, job_im.E0[2], text(raw"$ψ_2(x)$", :left, :bottom))
annotate!(-9.5, job_im.E0[3], text(raw"$ψ_3(x)$", :left, :bottom))
annotate!(-9.5, job_im.E0[4], text(raw"$ψ_4(x)$", :left, :bottom))
annotate!(-9.5, job_im.E0[5], text(raw"$ψ_5(x)$", :left, :bottom))
annotate!(-9.5, job_im.E0[6], text(raw"$ψ_6(x)$", :left, :bottom))
...
plot!(xlim=(-10,10), ylim=(-0.1,1.3), legend=:none, framestyle=:box, xlabel=raw"position $x$", ylabel=raw"energy $E$")
plot!(yticks=vcat([0.0],0.1:0.2:1.2))

savefig("figures/sec3_figures/harmonic_oscillator_eigenstates.pdf")
