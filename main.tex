...
\date{
    \today \\
    \normalsize \textit{Edition 0.3 Build 12}
}
...
\pagebreak
\input{sec3_commutator.tex}
\pagebreak
\input{sec4_one_dim.tex}
\pagebreak
\input{sec5_time_evol.tex}
\pagebreak
\input{sec6_identical_particles.tex}
\pagebreak
\input{sec7_central_field.tex}
\pagebreak
\input{sec8_spin.tex}
\pagebreak
\input{sec9_angular_momentum.tex}
\pagebreak
